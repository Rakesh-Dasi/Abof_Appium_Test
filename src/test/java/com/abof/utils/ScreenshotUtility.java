...
import com.abof.test.AbofTest;

//ITestListener is an Interface of TestNG which can Invoke it's specific method on Test Failure or Test Pass
public class ScreenshotUtility implements ITestListener
{
	// This method will execute before starting of Test suite.
	 ...
	 public void captureScreenShot(ITestResult result, String status) {
	  ...
	  //Pass the Class name where you want to get the screenshots
	  File scrFile = ((TakesScreenshot) AbofTest.driver).getScreenshotAs(OutputType.FILE);
